...
summary(logmodela)
```
Using income and balance predictor, a logistic model was built using all the data (nothing was stated if any subset to be used). The estimated standard errors of the coefficients of the logistic model were found to be 4.985*10-6 and 2.274*10-4 for income and balance variables, respectively.
...
```
The figure here plots the estimated SE of  for different B values. We see the estimation does not stabilize within B=4000 (note: each time we used seed 702).
