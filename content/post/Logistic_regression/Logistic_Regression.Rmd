...
More from this wiki article: https://en.wikipedia.org/wiki/Logistic_regression#:~:text=Logistic%20regression%20is%20a%20statistical,a%20form%20of%20binary%20regression).
...
Next, we will add the simple linear regression fit (fitted in class) on this plot. We use different color and line type to differentiate the two and add a legend to our plot.
